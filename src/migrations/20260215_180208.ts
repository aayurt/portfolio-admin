...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_archive_relation_to" AS ENUM('posts', 'tenants');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_archive_relation_to" AS ENUM('posts', 'tenants');
  ...
  CREATE TYPE "public"."enum_users_role" AS ENUM('super-admin', 'admin', 'editor', 'user');
  ...
  CREATE TABLE "tenants_languages" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"language" varchar
  ...
  CREATE TABLE "tenants" (
  	...
  	"social_media_github" varchar,
  	"logo_id" integer,
  	"description" varchar,
  	"intro_intro" varchar,
  	"intro_intro_description" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "abouts_work_experience" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"company" varchar,
  ...
  ALTER TABLE "tenants_languages" ADD CONSTRAINT "tenants_languages_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "tenants_links" ADD CONSTRAINT "tenants_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."tenants"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "tenants" ADD CONSTRAINT "tenants_avatar_id_media_id_fk" FOREIGN KEY ("avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "abouts_skills" ADD CONSTRAINT "abouts_skills_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."abouts"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "abouts_work_experience" ADD CONSTRAINT "abouts_work_experience_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."abouts"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "abouts_education" ADD CONSTRAINT "abouts_education_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."abouts"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "abouts" ADD CONSTRAINT "abouts_tenant_id_tenants_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_abouts_fk" FOREIGN KEY ("abouts_id") REFERENCES "public"."abouts"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "tenants_languages_order_idx" ON "tenants_languages" USING btree ("_order");
  CREATE INDEX "tenants_languages_parent_id_idx" ON "tenants_languages" USING btree ("_parent_id");
  CREATE INDEX "tenants_links_order_idx" ON "tenants_links" USING btree ("_order");
  CREATE INDEX "tenants_links_parent_id_idx" ON "tenants_links" USING btree ("_parent_id");
  ...
  CREATE INDEX "tenants_avatar_idx" ON "tenants" USING btree ("avatar_id");
  ...
  CREATE INDEX "abouts_skills_order_idx" ON "abouts_skills" USING btree ("_order");
  CREATE INDEX "abouts_skills_parent_id_idx" ON "abouts_skills" USING btree ("_parent_id");
  CREATE INDEX "abouts_work_experience_order_idx" ON "abouts_work_experience" USING btree ("_order");
  CREATE INDEX "abouts_work_experience_parent_id_idx" ON "abouts_work_experience" USING btree ("_parent_id");
  CREATE INDEX "abouts_education_order_idx" ON "abouts_education" USING btree ("_order");
  CREATE INDEX "abouts_education_parent_id_idx" ON "abouts_education" USING btree ("_parent_id");
  CREATE INDEX "abouts_tenant_idx" ON "abouts" USING btree ("tenant_id");
  CREATE INDEX "abouts_updated_at_idx" ON "abouts" USING btree ("updated_at");
  CREATE INDEX "abouts_created_at_idx" ON "abouts" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_abouts_id_idx" ON "payload_locked_documents_rels" USING btree ("abouts_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "tenants_languages" CASCADE;
  DROP TABLE "tenants_links" CASCADE;
  DROP TABLE "tenants" CASCADE;
  DROP TABLE "projects" CASCADE;
  DROP TABLE "projects_rels" CASCADE;
  DROP TABLE "abouts_skills" CASCADE;
  DROP TABLE "abouts_work_experience" CASCADE;
  DROP TABLE "abouts_education" CASCADE;
  DROP TABLE "abouts" CASCADE;
